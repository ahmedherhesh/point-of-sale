    ...
    <div class="content">
        <form @submit.prevent="submit" class="ctm-form mt-3">
            ...
            <div class="mb-3">
                ...
                <ClientSearch @change="value => form.client_id = value.id" :value="debit.client"
                    :suggestions="clients" />
                <span v-if="errors.client_id" class="text-danger text-direction-rtl mt-1 mb-1">{{ errors.client_id
                    }}</span>
            </div>
            <div class="mb-3">
